...
Бот поддерживает 13 платёжных провайдеров одновременно. Каждый провайдер включается отдельно, все работают параллельно через единый веб-сервер на порту `8080`.
...
13. Kassa AI
14. RioPay
15. Через поддержку (всегда последний)
