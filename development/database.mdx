---
title: "База данных"
description: "Полная схема базы данных: 68 таблиц, модели, связи и миграции"
---

## Обзор

Бот использует PostgreSQL через SQLAlchemy 2.x async ORM. Все модели определены в `app/database/models.py` (68 таблиц, включая 3 связующие M2M).
...
### Платежи и транзакции (14 таблиц)
...
**12 таблиц платежных провайдеров** — по одной на каждый провайдер. Все содержат: `user_id`, `status`, `transaction_id`, сумму и ID во внешней системе.
...
### Системные и контентные (11 таблиц)
...
| Платежи | 14 | transactions + 12 провайдеров + payment_method_configs |
...
| Системные | 11 | system_settings, service_rules, privacy_policies, faq_pages, main_menu_buttons и др. |
